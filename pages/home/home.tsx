...
import { getAllWorkingOnDate, getCurrentDay, getMarkedShifts, getWorkingTimeAtDate, months, notWorkingMessage } from "../../utils";
...
const Home: React.FC = () => {
    ...
    const [workingWith, setWorkingWith] = useState<any>(getWorkingWith(currentDay));
        ...
        <SafeAreaView style={{backgroundColor: "#34495e"}} />
            ...
            <View style={styles.container}>
                ...
                <View style={[styles.viewContainer, styles.workingContainer]}>
                    <Image style={styles.zamboniLogo} source={require("../../assets/zamboni-removebg-preview.png")} />
                    <Text style={{color: workingTime !== notWorkingMessage ? "#34495e" : "#e74c3c", fontSize: 18, fontWeight: "700"}}>{workingTime}</Text>
                </View>

                <ScrollView>
                    <CalendarView setCurrentDay={setCurrentDay} markedShifts={markedShifts}/>
