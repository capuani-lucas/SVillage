import { ADD_SCHEDULE, CHANGE_NAME, nameInitialState, NameState, ReduxAction, scheduleInitialState, ScheduleObject, ScheduleState } from "../reduxConstants";

export const nameReducer = (state: NameState = nameInitialState, action: ReduxAction): NameState => {
    switch(action.type) {
...
export const scheduleReducer = (state: ScheduleState = scheduleInitialState, action: ReduxAction): ScheduleState => {
